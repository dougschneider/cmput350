...
BWAPI::Unit * WorkerData::getWorkerRepairing(BWAPI::Unit * building)
{
    std::map<BWAPI::Unit *, BWAPI::Unit *>::iterator it = workerRepairMap.begin();

    for(; it != workerRepairMap.end(); ++it)
	{
